...
public class SauceDemoScripts {
	 ...
	 * "C:\\Users\\Owner\\OneDrive\\Desktop\\program\\geckodriver.exe"); driver =
	 * new FirefoxDriver(); } else if (browser.equalsIgnoreCase("chrome")) {
	 * 
	 * System.setProperty("webdriver.chrome.driver",
	 * "C:\\Users\\Owner\\OneDrive\\Desktop\\program\\chromedriver.exe"); driver =
	 * new ChromeDriver(); }
	 * 
	 * else if (browser.equalsIgnoreCase("Edge")) {
	 * System.setProperty("webdriver.edge.driver",
	 * "C:\\Users\\Owner\\OneDrive\\Desktop\\program\\msedgedriver.exe"); driver =
	 * new EdgeDriver(); } else { throw new Exception("Browser is not correct"); }
	 * sd = new SauceDemo(driver); driver.get("https://www.saucedemo.com/");
	 * driver.manage().window().maximize();
	 * driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS); }
	 */

	
	  @BeforeTest public void setupTest() throws InterruptedException {
